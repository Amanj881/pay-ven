...
function POR() {
	return (
      ...
      <div className="flex justify-between">
        ...
        <span className="text-center font-bold text-2xl mb-8 my-3 uppercase">Pay Out Request</span>
          ...
          <thead>
            <tr>
              <th className="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
               <input id="select" type="checkbox" class="form-checkbox h-4 w-4 text-indigo-600 transition duration-150 ease-in-out"/>
              </th>
              <th className="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                Organisation
              </th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr>
              ...
              <td className="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                <a href="#" className="text-indigo-600 hover:text-indigo-900 mr-4">Payout</a>
                <a href="#" className="text-indigo-600 hover:text-indigo-900">hold</a>
